...
try {
    ...
    $f_celebracion = fechaNull($_POST['fecha_matrimonio']);
    $h_celebracion = !empty($_POST['hora_matrimonio']) ? $_POST['hora_matrimonio'] : NULL;
    ...
    $types = "ssssssssssssiisssisssississsssssssssssssssss";
